import { FaGithub, FaTwitterSquare, FaLinkedin, FaInstagram } from "react-icons/fa";
    ...
    <footer className={Styles.footerContainer}>
      <div className={Styles.footerContent}>
        <div className={Styles.column}>
          <h2>About Brewcafe</h2>
          <p>
            Discover the warmth of Brewcafe, a haven for coffee and tea lovers.
        ...
        <div className={Styles.column}>
          ...
          <div className={Styles.socialIcons}>
            ...
            <a href="https://www.instagram.com/your_instagram" className={Styles.iconLink}>
            <FaInstagram size={30} />
            </a>
          </div>
        </div>
      ...
      <div className={Styles.footerBottom}>
        <p>&copy; 2024 BrewCafe. All rights reserved.</p>
      </div>
    </footer>
  );
};
